...
DEFAULT_LAYOUT: dict[str, Any] = {
    ...
    "pages": [
        ...
        #     in primo piano. Soprattutto informative: i dati in alto, i
        #     comandi nella riga in basso. Le scorciatoie sono quelle di
        #     default delle app: si correggono dalla GUI se una versione le
        #     cambia.
        {
            "name": "WhatsApp",
            ...
            "grid": {"cols": 3, "rows": 2},
            "slots": [
                {"pos": [0, 0], "kind": "info", "label": "{whatsapp.badge}",
                 "caption": "non letti", "icon": "mdi:whatsapp"},
                {"pos": [1, 0], "kind": "info", "label": "{window.title}",
                 "caption": "chat aperta", "icon": "mdi:message-text-outline", "span": 2},
                {"pos": [0, 1], "label": "Cerca", "icon": "mdi:magnify",
                 "action": {"type": "keys", "keys": "cmd+f"}},
                {"pos": [1, 1], "label": "Nuova chat",
                 "icon": "mdi:message-plus-outline", "action": {"type": "keys", "keys": "cmd+n"}},
                {"pos": [2, 1], "label": "Archivia",
                 "icon": "mdi:archive-arrow-down", "action": {"type": "keys", "keys": "cmd+e"}},
            ],
        },
        {
            "name": "Mail",
            ...
            "grid": {"cols": 3, "rows": 3},
            "slots": [
                {"pos": [0, 0], "kind": "info", "label": "{mail.unread}",
                 "caption": "non lette", "icon": "mdi:email"},
                {"pos": [1, 0], "kind": "info", "label": "{mail.drafts}",
                 "caption": "bozze", "icon": "mdi:email-edit-outline"},
                {"pos": [2, 0], "kind": "info", "label": "{window.title}",
                 "caption": "casella", "icon": "mdi:inbox"},
                {"pos": [0, 1], "kind": "info", "span": 3,
                 "label": "{mail.latest_subject}", "caption": "ultimo arrivato · da {mail.latest_sender}", "icon": "mdi:email-newsletter"},
                {"pos": [0, 2], "label": "Nuovo", "icon": "mdi:email-plus",
                 "action": {"type": "keys", "keys": "cmd+n"}},
                {"pos": [1, 2], "label": "Rispondi", "icon": "mdi:reply",
                 "action": {"type": "keys", "keys": "cmd+r"}},
                {"pos": [2, 2], "label": "Archivia",
                 "icon": "mdi:archive-arrow-down", "action": {"type": "keys", "keys": "ctrl+cmd+a"}},
            ],
        },
        {
            "name": "Slack",
            ...
            "grid": {"cols": 3, "rows": 2},
            "slots": [
                {"pos": [0, 0], "kind": "info", "label": "{slack.badge}",
                 "caption": "non letti", "icon": "mdi:slack"},
                {"pos": [1, 0], "kind": "info", "label": "{window.title}",
                 "caption": "canale corrente", "icon": "mdi:pound", "span": 2},
                {"pos": [0, 1], "label": "Non letti",
                 "icon": "mdi:email-mark-as-unread", "action": {"type": "keys", "keys": "shift+cmd+a"}},
        ...
        {
            "name": "DataGrip",
            "app": "com.jetbrains.datagrip",
            "grid": {"cols": 3, "rows": 2},
            "slots": [
                {"pos": [0, 0], "kind": "info", "label": "{window.title}",
                 "caption": "progetto e console", "icon": "mdi:database", "span": 3},
                {"pos": [0, 1], "label": "Esegui", "icon": "mdi:play",
                 "action": {"type": "keys", "keys": "cmd+return"}},
                {"pos": [1, 1], "label": "Cerca azione",
                 "icon": "mdi:magnify", "action": {"type": "keys", "keys": "shift+cmd+a"}},
                {"pos": [2, 1], "label": "File recenti",
                 "icon": "mdi:history", "action": {"type": "keys", "keys": "cmd+e"}},
            ],
        },
        {
            "name": "Claude",
            ...
            "slots": [
                {"pos": [0, 0], "kind": "info", "label": "{window.title}",
                 "caption": "conversazione corrente", "icon": "mdi:chat-outline", "span": 2},
                {"pos": [2, 0], "kind": "info", "icon": "mdi:timer-sand",
                 "label": "{claude.session_used|int}%", "caption": "sessione · reset {claude.session_resets}"},
                {"pos": [0, 1], "label": "Nuova chat",
                 "icon": "mdi:chat-plus-outline", "action": {"type": "keys", "keys": "cmd+n"}},
                {"pos": [1, 1], "label": "Cerca", "icon": "mdi:magnify",
                 "action": {"type": "keys", "keys": "cmd+k"}},
                {"pos": [2, 1], "label": "Invio",
                 "icon": "mdi:keyboard-return", "action": {"type": "keys", "keys": "return"}},
            ],
        },
        {
            "name": "Calendar",
            ...
            "grid": {"cols": 3, "rows": 3},
            "slots": [
                {"pos": [0, 0], "kind": "info", "label": "{calendar.next}",
                 "caption": "prossimo evento", "icon": "mdi:calendar-clock", "span": 2},
                {"pos": [2, 0], "kind": "info", "label": "{calendar.next_at}",
                 "caption": "alle", "icon": "mdi:clock-outline"},
                {"pos": [0, 1], "kind": "info", "caption": "eventi oggi",
                 "label": "{calendar.count_today}", "icon": "mdi:calendar-today"},
                {"pos": [1, 1], "kind": "info", "label": "{window.title}",
                 "caption": "vista", "icon": "mdi:calendar-month", "span": 2},
                {"pos": [0, 2], "label": "Oggi", "icon": "mdi:calendar-today",
                 "action": {"type": "keys", "keys": "cmd+t"}},
                {"pos": [1, 2], "label": "Settimana",
                 "icon": "mdi:calendar-week", "action": {"type": "keys", "keys": "cmd+2"}},
                {"pos": [2, 2], "label": "Nuovo", "icon": "mdi:calendar-plus",
                 "action": {"type": "keys", "keys": "cmd+n"}},
            ],
        },
        {
            ...
            "slots": [
                {"pos": [0, 0], "kind": "info", "label": "{media.title}",
                 "caption": "{media.artist}", "icon": "mdi:music", "span": 3},
                {"pos": [0, 1], "kind": "info", "label": "{media.album}",
                 "caption": "album", "icon": "mdi:album", "span": 2},
                {"pos": [2, 1], "kind": "info", "label": "{media.duration}",
                 "caption": "durata", "icon": "mdi:timer-outline"},
                {"pos": [0, 2], "kind": "info", "label": "{media.volume}%",
                 "caption": "volume", "icon": "mdi:volume-high"},
                {"pos": [1, 2], "label": "Shuffle", "state": "media.shuffle",
                 "icon": "mdi:shuffle-variant", "action": {"type": "media", "op": "shuffle_toggle"}},
                {"pos": [2, 2], "label": "Ripeti", "icon": "mdi:repeat",
                 "state": "media.repeat", "action": {"type": "media", "op": "repeat_toggle"}},
                {"pos": [0, 3], "label": "Indietro",
                 "icon": "mdi:skip-previous", "action": {"type": "media", "op": "prev"}},
                {"pos": [1, 3], "label": "Play / Pausa",
                 "icon": "mdi:play-pause", "action": {"type": "media", "op": "play_pause"}},
                {"pos": [2, 3], "label": "Avanti", "icon": "mdi:skip-next",
        ...
        },
        {
            ...
            "grid": {"cols": 3, "rows": 2},
            "slots": [
                {"pos": [0, 0], "kind": "info", "label": "{chrome.title}",
                 "caption": "{chrome.host}", "icon": "mdi:google-chrome", "span": 2},
                {"pos": [2, 0], "kind": "info", "label": "{chrome.tabs}",
                 "caption": "schede aperte", "icon": "mdi:tab"},
                {"pos": [0, 1], "label": "Nuova scheda",
                 "icon": "mdi:tab-plus", "action": {"type": "keys", "keys": "cmd+t"}},
                {"pos": [1, 1], "label": "Ricarica", "icon": "mdi:refresh",
                 "action": {"type": "keys", "keys": "cmd+r"}},
                {"pos": [2, 1], "label": "Chiudi scheda",
                 "icon": "mdi:tab-remove", "action": {"type": "keys", "keys": "cmd+w"}},
            ],
        },
        {
            "name": "Claude Code",
